...
@JmixEntity
@Table(name = "DWH_API_HEADERS", indexes = {
        @Index(name = "IDX_DWH_API_HEADERS_API_SETTING", columnList = "API_SETTING_ID")
})
@Entity(name = "dwh_ApiHeaders")
public class ApiHeader extends BaseEntity {
    @JmixGeneratedValue
